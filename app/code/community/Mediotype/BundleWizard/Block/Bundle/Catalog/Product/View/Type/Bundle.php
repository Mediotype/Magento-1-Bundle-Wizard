 ...
 * Time: 8:00 AM
 */
class Mediotype_BundleWizard_Block_Bundle_Catalog_Product_View_Type_Bundle extends Mage_Bundle_Block_Catalog_Product_View_Type_Bundle
{
    public function getJsonConfig()
    {
        ...
        foreach ($optionsArray as $_option) {
            ...
            $option = array(
                ...
                'isMulti' => in_array($_option->getType(), array('multi', 'checkbox', "textbox", "autoadd")),
                'position' => $position++
            );
